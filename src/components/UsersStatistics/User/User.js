...
import {
  LineChart, XAxis, YAxis, Tooltip, CartesianGrid, Line, ResponsiveContainer
} from 'recharts'
import users from '../../users.json'
import users_statistics from '../../users_statistic.json'
import arrow from '../img/arrow.svg'
import './user.css'

export default function User(props) {
  const userStatistics =
    users_statistics.filter(user => +props.match.params.id === user.user_id)
  ...
  return (
    <div>
      ...
      <h3 className="h3 user__subtitle">
        Clicks
      </h3>
      <div className="user__graph">
        <ResponsiveContainer width="90%" height={280}>
          ...
          >
            ...
            <Line type="monotone" dataKey="clicks" stroke="#3a80ba" yAxisId={0} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      <h3 className="h3 user__subtitle">
      ...
      <div className="user__graph">
        <ResponsiveContainer width="90%" height={280}>
          ...
          >
            ...
            <Tooltip />
            <CartesianGrid stroke="#f5f5f5" vertical={false} />
            <Line type="monotone" dataKey="page_views" stroke="#3a80ba" yAxisId={0} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
